...
namespace FirstPartKursov
{
    class create_bd
    {
        ...
        public void table_create()
        {
            ...
            sc.ExecuteNonQuery();
            sc = sql.CreateCommand();
            sc.CommandText = "create table goods(id_goods INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name_goods TEXT NOT NULL, surrency TEXT NOT NULL, price INTEGER NOT NULL,id_provider INTEGER NOT NULL, FOREIGN KEY(id_provider) REFERENCES provider (id_provider))";
            sc.ExecuteNonQuery();
            sc = sql.CreateCommand();
        ...
        public void table_insert()
        {
            ...
            sc.ExecuteNonQuery();
            sc = sql.CreateCommand();
            sc.CommandText = "insert into 'goods' ( 'name_goods','surrency','price','id_provider') values ( 'гитара','rub',4999,1);";
            sc.ExecuteNonQuery();
            sc = sql.CreateCommand();
            sc.CommandText = "INSERT INTO 'storage' ('id_office', 'id_goods','amount_goods') VALUES (1, 1,1);";
            sc.ExecuteNonQuery();
            sc.CommandText = "INSERT INTO 'storage' ('id_office', 'id_goods','amount_goods') VALUES (2, 1,0);";
            sc.ExecuteNonQuery();
            sc.CommandText = "INSERT INTO 'storage' ('id_office', 'id_goods','amount_goods') VALUES (3, 1,1);";
            sc.ExecuteNonQuery();
            sc = sql.CreateCommand();
